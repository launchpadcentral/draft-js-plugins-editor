...
var PluginEditor = function (_Component) {
  ...
  _createClass(PluginEditor, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var _editorState = _draftJs.EditorState.set(nextProps.editorState, { decorator: compositeDecorator });

      if (nextProps.editorState.getCurrentContent().last().get("text") !== this.props.editorState.getCurrentContent().last().get("text")) {
