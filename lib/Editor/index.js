...
var PluginEditor = function (_Component) {
  ...
  function PluginEditor(props) {
    ...
    var compositeDecorator = (0, _createCompositeDecorator2.default)(_this.resolveDecorators(), _this.getEditorState, _this.onChange);

    var _editorState = _draftJs.EditorState.set(_this.props.editorState, { decorator: compositeDecorator });
    _this.state = {
      editorState: (0, _moveSelectionToEnd2.default)(_editorState)
    };
    return _this;
  }
  ...
  _createClass(PluginEditor, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.editorState.getDecorator().length !== this.props.editorState.getDecorator().length) {
        _editorState = _draftJs.EditorState.set(nextProps.editorState, { decorator: compositeDecorator });
        this.setState({ editerState: (0, _moveSelectionToEnd2.default)(_editorState) });
      }
    }
  }, {
