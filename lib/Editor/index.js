...
var PluginEditor = function (_Component) {
  ...
  function PluginEditor(props) {
    ...
    _this.compositeDecorator = (0, _createCompositeDecorator2.default)(_this.resolveDecorators(), _this.getEditorState, _this.onChange);
    _this._editorState = _draftJs.EditorState.set(_this.props.editorState, { decorator: _this.compositeDecorator });
    _this.onChange((0, _moveSelectionToEnd2.default)(_this._editorState));
